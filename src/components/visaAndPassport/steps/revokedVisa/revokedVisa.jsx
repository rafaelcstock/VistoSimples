        ...
        <div className="div-margin">
            ...
            <div className="div-marital-padding">
                <div className="padding-bottom-title-input">
                    <span className="title-header-2">Já revogaram o seu visto?<span style={{ color: 'red' }}>*</span></span>
                </div>
                ...
                <div className="padding-visa">
                    <div>
                        ...
                        <div className="padding-bottom-1">
                            <TextField id="outlined-basic" className="style-input-visa" placeholder="Escreva o seu primeiro nome" variant="outlined" />
                        </div>
                    </div>
                </div>
            </div>
